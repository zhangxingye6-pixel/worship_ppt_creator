...
//        }
    ...
    private List<String> parseReleaseResponse(GithubReleaseEntity githubReleaseEntity) {
        ...
        String versionInfo = stringBuilder.append("发现新版本: ").append(githubReleaseEntity.tag_name()).append("\n")
                ...
                .append("-").append("下载地址: <a href='https://codeberg.org/api/packages/zhangxingye6-pixel/generic/worship-ppt-creator/").append(githubReleaseEntity.tag_name()).append("/worship-ppt-creator-macos-intel-").append(SystemConfig.getString(Dict.ProjectProperty.VERSION)).append(".zip'>").append("点击前往下载macos_x86_64版本").append("</a>").append("\n").toString();
        // 清空
